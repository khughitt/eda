...
bdat$subsample(500)$t()$plot_pca(color_var='gdc_cases.project.name', color_key='coldata')
bdat$subsample(500)$t()$plot_tsne(color_var='gdc_cases.project.name', color_key='coldata')
bdat$subsample(500)$t()$plot_umap(color_var='gdc_cases.project.name', color_key='coldata')
